...
// printf("Gmatt chart \n waiting time %d\t proceess %d\t %d ",processes[i].waiting_time,processes[i],processes[i].burst_time);
    ...
    printf("Average Waiting Time of processes: %.2f\n", total_waiting_time / n);
}
...
int main() {
    ...
    for (i = 0; i < n; i++) {
        ...
        printf("burst time for each processes: ");
        scanf("%d", &processes[i].burst_time);
        printf("give the priority of processes: ");
    ...
    printf("5. Schedule for Round Robin\n");
